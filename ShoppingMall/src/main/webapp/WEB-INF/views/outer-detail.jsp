...
<script>
	 function goto_url(act) {
	  document.outer_detail.action = act;
	  document.outer_detail.submit();
	}
</script>
...
<body>
	<jsp:include page="header.jsp" flush="false" />
      ...
      <!-- Product Description -->
      <form name="outer_detail" method="post" accept-charset="utf-8" onsubmit="document.charset='utf-8';">
      <input type="hidden" name="product_no" id="product_no" value="${outerdetail.dto.product_no}"> 
      <input type="hidden" name="pro_name" value="${outerdetail.dto.pro_name}">
      <input type="hidden" name="pro_price" value="${outerdetail.dto.pro_price}">
      <div class="container">
        <div class="row">
          <div class="col-lg-7">
            <!-- Carousel -->
            <div id="carouselCus1" class="js-carousel g-pt-10 g-mb-10"
					...
					<div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
						<img class="img-fluid2 w-100"
							src="${contextPath}/resources/product/${outerdetail.dto.product_no}_1.jpg"
...
<!--                 <h1 class="g-font-weight-300 mb-4">Men's Water<br>Resistant Jacket</h1> -->
                <h1 class="g-font-weight-300 mb-4">${outerdetail.dto.pro_name}</h1>
              ...
              <div class="g-mb-30">
                ...
                <span class="g-color-black g-font-weight-500 g-font-size-30 mr-2">${outerdetail.dto.pro_price}</span>
<!--                 <s class="g-color-gray-dark-v4 g-font-weight-500 g-font-size-16">$101.00</s> -->
              ...
              <div class="d-flex justify-content-between align-items-center g-brd-bottom g-brd-gray-light-v3 py-3" role="tab">
                ...
                <c:choose>
              <c:when test="${not empty outerdetail.color}">
              <div class="selectbox"> 
              <select name="select_color"> 
              <option selected>-----</option>
                <c:forEach var="color" items="${outerdetail.color}">
              <option>${color}</option> 
                </c:forEach>
              </select> 
              </div>
...
<!--                   </li> -->
      ...
      <div id="details" class="container-fluid g-px-0">
        <div class="row no-gutters g-min-height-100vh">
          ...
          <div class="col-md-6 g-bg-size-cover g-min-height-300" data-bg-img-src="${contextPath}/resources/product/${outerdetail.dto.product_no}_2.jpg"></div>
        </div>
      </div>
      <!-- End Details -->
