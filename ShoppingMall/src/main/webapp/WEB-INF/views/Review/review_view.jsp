...
<link rel="stylesheet"
	href="${contextPath}/resources/WB0412697/html/assets/vendor/prism/themes/prism.css">
<link rel="stylesheet"
...
<!-- CSS Unify -->
<link rel="stylesheet"
	href="${contextPath}/resources/WB0412697/html/assets/css/unify.css">
...
<body>
 <jsp:include page="../header.jsp" flush="false" />
	...
	<section class="container-fluid">
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-sm-8 col-lg-9 col-xl-10 g-py-30 g-pa-30--md">
				...
				<form name="view" style="margin: 0 auto;">
					<section class="g-pb-100"  style="margin: 0 auto;">
						<div class="container" style="margin: 0 auto;">
							<div class="text-center g-mb-50"  style="margin: 0 auto;">
								<h2 class="h4">
									리뷰 <span class="g-color-primary g-ml-5">#읽기</span>
								</h2>
							</div>

							<div id="shortcode1"  style="margin: 0 auto;">
								<div class="shortcode-html"  style="margin: 0 auto;">
									<!--Basic Table-->
									<div class="table-responsive">
										<table class="table table-bordered u-table--v2"
											...
											<tr>
												...
												<td class="align-middle" name="REVIEW_TITLE">
													${view.REVIEW_TITLE}</td>
											</tr>
											...
											<tbody>
												...
												<tr>
													...
													<td class="align-middle" name="M_ID">${view.BOARD_WRITER}</td>
												</tr>

												<tr>
													<td class="align-middle text-nowrap">
														<h4 class="h6 g-mb-2">사진</h4>
													</td>

													<td class="align-middle" name="PRODUCT_NO">
													<img alt="Image Description" src="${contextPath}/resources/product/${view.PRODUCT_NO}_1.jpg" width="500" height="500">
									        		</td>
												</tr>
	...
	<script
		src="${contextPath}/resources/WB0412697/html/assets/vendor/jquery.peity.min.js"></script>
	...
	<script
		src="${contextPath}/resources/WB0412697/html/assets/js/components/hs.rating.js"></script>
