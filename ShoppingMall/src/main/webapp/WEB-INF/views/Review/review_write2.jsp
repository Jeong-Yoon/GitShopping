...
<body>
   ...
   <div class="col-sm-8 col-md-9 col-xl-10 g-py-30 g-pa-30--md">
                           ...
                           <div class="form-group g-mb-25">
                              <label for="exampleInputPassword1">제목</label> <input
                                 ...
                                 class="form-control form-control-md rounded-0"
                                  name="REVIEW_TITLE" value="${REVIEW_TITLE}" >
                        </div>                        
    <select class="custom-select rounded-0"  name="ctype" onChange=clotheschange(document.clothes.ctype.options.selectedIndex)>
      ...
      <select class="custom-select rounded-0" name="detail" id="ponies" onChange="javascript:selectEvent(this)">
         <option value="" >-선택-</option>
      <c:forEach var="result" items="${list}">

         <option value="${result.product_no}">${result.pro_name}</option>

      </c:forEach>   
      </select>
      &nbsp; &nbsp; 
      <img alt="선택해주세요." id="mypony" src=""    width="100" height="100">

                           <div class="form-group g-mb-25">
                              <label for="exampleTextarea">내용</label>
                              <textarea class="form-control form-control-md rounded-0"
                                  name="REVIEW_CONTENT"  rows="6" cols="50">${REVIEW_CONTENT}</textarea>
                           </div>
   ...
   <script type="text/javascript">
         function selectEvent(selectObj) {
            var product_no = selectObj.value;            
         }
   </script>
   ...
   var myf = function() {
      ...
      var shownewf = function() {
         var newpony = $("#ponies").val(); 
         var context = '<c:out value="${contextPath}"/>';
         $("#mypony").attr("src", context +"/resources/product/" +newpony + "_1.jpg").fadeIn("slow");
      }

      $("#mypony").fadeOut("fast", shownewf);
   }

   $("#ponies").bind("change", myf);
   </script>
