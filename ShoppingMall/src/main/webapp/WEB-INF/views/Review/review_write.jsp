...
<body>
	...
	<div class="col-sm-8 col-md-9 col-xl-10 g-py-30 g-pa-30--md">
		<h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-35">REVIEW PAGE</h1>
						...
						<div id="shortcode1">
							<div class="shortcode-html">
								...
								<form class="g-brd-around g-brd-gray-light-v4 g-pa-30 g-mb-30"
									name="insert" action="review/insert.do">

									<div class="form-group g-mb-25">
										<label for="exampleInputPassword1">제목</label> 
										<input type="text"	class="form-control form-control-md rounded-0" name="REVIEW_TITLE" placeholder="Title">
									</div>
