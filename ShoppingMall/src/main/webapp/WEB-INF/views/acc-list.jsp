...
<body>
					...
					<div class="row g-pt-30 g-mb-50">
						...
						<div class="col-6 col-lg-4 g-mb-30">
							...
							<figure>
								<div class="g-pos-rel g-mb-20">
									<img class="img-fluid"
										src="${contextPath}/resources/WB0412697/html/assets/img-temp/480x700/img5.jpg"
										alt="Image Description">
						...
						<div class="col-6 col-lg-4 g-mb-30">
							...
							<figure>
								<div class="g-pos-rel g-mb-20">
									<img class="img-fluid"
										src="${contextPath}/resources/WB0412697/html/assets/img-temp/480x700/img6.jpg"
										alt="Image Description">
								</div>
						...
						<div class="col-6 col-lg-4 g-mb-30">
							...
							<figure>
								<div class="g-pos-rel g-mb-20">
									<img class="img-fluid"
										src="${contextPath}/resources/WB0412697/html/assets/img-temp/480x700/img7.jpg"
										alt="Image Description">
						...
						<div class="col-6 col-lg-4 g-mb-30">
							...
							<figure>
								<div class="g-pos-rel g-mb-20">
									<img class="img-fluid"
										src="${contextPath}/resources/WB0412697/html/assets/img-temp/480x700/img8.jpg"
										alt="Image Description">
								</div>
						...
						<div class="col-6 col-lg-4 g-mb-30">
							...
							<figure>
								<div class="g-pos-rel g-mb-20">
									<img class="img-fluid"
										src="${contextPath}/resources/WB0412697/html/assets/img-temp/480x700/img9.jpg"
										alt="Image Description">
								</div>
	...
	<script
		src="${contextPath}/resources/WB0412697/html/assets/js/helpers/hs.rating.js"></script>
	<script
