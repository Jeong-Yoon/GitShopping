              ...
              <div class="u-shadow-v21">
                <div class="g-pos-rel">
                  ...
                  <div class="js-carousel text-center g-rounded-50 g-bg-gray-light-v5 g-py-3"
                    ...
                    <div class="js-slide">
                      <img class="img-fluid" src="resources/WB0412697/html/assets/img-temp/650x900/img1.jpg" alt="Image Description">
                    </div>
                    <div class="js-slide">
                      <img class="img-fluid" src="resources/WB0412697/html/assets/img-temp/650x900/img2.jpg" alt="Image Description">
                    </div>
                    <div class="js-slide">
                      <img class="img-fluid" src="resources/WB0412697/html/assets/img-temp/650x900/img3.jpg" alt="Image Description">
                    </div>
                  </div>
                  <!-- End Product Image -->
                      ...
                      <div class="js-carousel text-center g-rounded-50 g-bg-gray-light-v5 g-py-3"
                        ...
                        <div class="js-slide mx-auto">
                          <label class="form-check-inline u-check g-pl-17">
                            <input class="hidden-xs-up" name="radInline3_1" type="radio">
              ...
              <div class="u-shadow-v21">
                <div class="g-pos-rel">
                  ...
                  <div class="js-carousel text-center g-rounded-50 g-bg-gray-light-v5 g-py-3"
                       ...
                       data-autoplay="true">
                    <div class="js-slide">
                      <img class="img-fluid" src="resources/WB0412697/html/assets/img-temp/650x900/img4.jpg" alt="Image Description">
                    </div>
                    <div class="js-slide">
                      <img class="img-fluid" src="resources/WB0412697/html/assets/img-temp/650x900/img5.jpg" alt="Image Description">
                    </div>
                    <div class="js-slide">
                      <img class="img-fluid" src="resources/WB0412697/html/assets/img-temp/650x900/img6.jpg" alt="Image Description">
                    </div>
                  </div>
                  <!-- End Product Image -->
              ...
              <div class="u-shadow-v21">
                <div class="g-pos-rel">
                  ...
                  <div class="js-carousel text-center g-rounded-50 g-bg-gray-light-v5 g-py-3"
                       ...
                       data-autoplay="true">
                    <div class="js-slide">
                      <img class="img-fluid" src="resources/WB0412697/html/assets/img-temp/650x900/img7.jpg" alt="Image Description">
                    </div>
                    <div class="js-slide">
                      <img class="img-fluid" src="resources/WB0412697/html/assets/img-temp/650x900/img8.jpg" alt="Image Description">
                    </div>
                  </div>
                  <!-- End Product Image -->
              ...
              <div class="u-shadow-v21">
                <div class="g-pos-rel">
                  ...
                  <div class="js-carousel text-center g-rounded-50 g-bg-gray-light-v5 g-py-3"
                       ...
                       data-arrow-right-classes="fa fa-angle-right g-right-5">
                    <div class="js-slide">
                      <img class="img-fluid" src="resources/WB0412697/html/assets/img-temp/650x900/img9.jpg" alt="Image Description">
                    </div>
                    <div class="js-slide">
                      <img class="img-fluid" src="resources/WB0412697/html/assets/img-temp/650x900/img10.jpg" alt="Image Description">
                    </div>
                  </div>
                  <!-- End Product Image -->
      ...
      <div class="container g-pt-100 g-pb-70">
        ...
        <div class="row g-mx-minus-10">
          <div class="col-sm-6 col-md-4 g-px-10 g-mb-30">
            ...
            <article class="u-block-hover">
              <div class="g-bg-cover g-bg-white-gradient-opacity-v1--after">
                <img class="d-flex align-items-end u-block-hover__main--mover-down" src="resources/WB0412697/html/assets/img-temp/650x650/img1.jpg" alt="Image Description">
              </div>
          ...
          <div class="col-sm-6 col-md-4 g-px-10 g-mb-30">
            ...
            <article class="u-block-hover">
              <div class="g-bg-cover g-bg-white-gradient-opacity-v1--after">
                <img class="d-flex align-items-end u-block-hover__main--mover-down" src="resources/WB0412697/html/assets/img-temp/650x650/img2.jpg" alt="Image Description">
              </div>
              <div class="u-block-hover__additional--partially-slide-up text-center g-z-index-1 mt-auto">
                <div class="u-block-hover__visible g-pa-25">
          ...
          <div class="col-sm-6 col-md-4 g-px-10 g-mb-30">
            ...
            <article class="u-block-hover">
              <div class="g-bg-cover g-bg-white-gradient-opacity-v1--after">
                <img class="d-flex align-items-end u-block-hover__main--mover-down" src="resources/WB0412697/html/assets/img-temp/650x650/img3.jpg" alt="Image Description">
              </div>
              <div class="u-block-hover__additional--partially-slide-up text-center g-z-index-1 mt-auto">
                <div class="u-block-hover__visible g-pa-25">
