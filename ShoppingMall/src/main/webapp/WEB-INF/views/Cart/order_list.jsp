  ...
  <head>
   ...
   <c:set var = "deliver" value = "0" />
    ...
    function goto_url(act) {
       document.order_list.action = act;
  ...
  <body>
    <main>
      ...
      <div class="container g-pt-100 g-pb-70">
        <form class="js-validate js-step-form" data-progress-id="#stepFormProgress" data-steps-id="#stepFormSteps" name="order_list">
          <div class="g-mb-100">
            <!-- Step Titles -->
                          ...
                          <td class="text-left g-py-25">
                            ...
                            <div class="d-inline-block align-middle">
                              ...
                              <ul class="list-unstyled g-color-gray-dark-v4 g-font-size-12 g-line-height-1_6 mb-0">
                                <li>Color: ${row.order_color}</li>
                                <li>Size: ${row.order_size}</li>
                              </ul>
                            </div>
                          </td>
...
<!--                             </div> -->
                          ...
                          <td class="text-right g-color-black">
                            ...
                            <c:set var= "sum" value="${sum + row.pro_price*row.order_quantity}"/>
                ...
                <div class="col-md-4 g-mb-30">
                  ...
                  <div class="g-bg-gray-light-v5 g-pa-20 g-pb-50 mb-4">
                    <h4 class="h6 text-uppercase mb-3">주문번호: ${order_no}</h4>
