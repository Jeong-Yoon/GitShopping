...
<link rel="stylesheet"
	href="../resources/WB0412697/html/assets/vendor/chosen/chosen.css">
<link rel="stylesheet"
		...
		<form class="js-validate js-step-form"
			...
			<div class="g-mb-100">
				...
				<ul id="stepFormProgress"
					...
					<li class="col-3 list-inline-item g-mb-20 g-mb-0--sm"><span
						class="d-block u-icon-v2 u-icon-size--sm g-rounded-50x g-brd-primary g-color-primary g-color-white--active g-bg-primary--active g-color-white--checked g-bg-primary--checked mx-auto mb-3">
							<i class="g-font-style-normal g-font-weight-700 g-hide-check">♥</i>
							<i class="fa fa-check g-show-check"></i>
					</span>
						<h4 class="g-font-size-16 text-uppercase mb-0">찜 목록</h4></li>
						...
						<div class="col-md-8 g-mb-30">
							...
							<div class="g-overflow-x-scroll g-overflow-x-visible--lg">
								<table class="text-center w-100">
									<thead
										class="h6 g-brd-bottom g-brd-gray-light-v3 g-color-black text-uppercase">
										<tr>
...
<!-- 						</div> -->
	...
	<!-- End Checkout Form --> <a class="js-go-to u-go-to-v2" href="#"
		data-type="fixed"
		data-position='{
           "bottom": 15,
           "right": 15
	...
	</a> <jsp:include page="../footer.jsp" flush="false" /> </main>
	...
	<script
		src="../resources/WB0412697/html/assets/vendor/jquery-validation/dist/jquery.validate.min.js"></script>
	<script
		src="../resources/WB0412697/html/assets/vendor/chosen/chosen.jquery.js"></script>
	<script
		src="../resources/WB0412697/html/assets/vendor/image-select/src/ImageSelect.jquery.js"></script>
	...
	<script
		src="../resources/WB0412697/html/assets/js/components/hs.select.js"></script>
	<script
		src="../resources/WB0412697/html/assets/js/components/hs.count-qty.js"></script>
	<script
		src="../resources/WB0412697/html/assets/js/components/hs.step-form.js"></script>
	<script
		src="../resources/WB0412697/html/assets/js/components/hs.validation.js"></script>
	<script
