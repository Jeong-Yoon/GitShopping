              ...
              <div class="row">
                <div class="col-md-8 g-mb-30">
                  <div class="row">
                    ...
                    <div class="col-sm-6 g-mb-20">
                      <div class="form-group">
                        ...
                        <input id="inputGroup5" class="form-control u-form-control g-placeholder-gray-light-v1 rounded-0 g-py-15" name="lastName" type="text" placeholder="111-222" required data-msg="필수로 입력해야 합니다." data-error-class="u-has-error-v1" data-success-class="u-has-success-v1">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-6 g-mb-20">
                      <div class="form-group">
                        <label class="d-block g-color-gray-dark-v2 g-font-size-13">이메일주소</label>
                        <input id="inputGroup6" class="form-control u-form-control g-placeholder-gray-light-v1 rounded-0 g-py-15" name="email" type="email" placeholder="alwayswearing@gmail.com" required data-msg="이메일 형식이 아닙니다." data-error-class="u-has-error-v1" data-success-class="u-has-success-v1">
                      </div>
                    </div>
