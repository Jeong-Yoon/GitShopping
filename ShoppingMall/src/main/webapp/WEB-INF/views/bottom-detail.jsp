...
<script>
	 function goto_url(act) {
	  document.bottomdetail.action = act;
	  document.bottomdetail.submit();
	}
</script>
...
<body>
	<jsp:include page="header.jsp" flush="false" />
      ...
      <!-- Product Description -->
      <form name="bottomdetail" method="post" accept-charset="utf-8" onsubmit="document.charset='utf-8';">
      <input type="hidden" name="product_no" id="product_no" value="${bottomdetail.dto.product_no}"> 
      <input type="hidden" name="pro_name" value="${bottomdetail.dto.pro_name}">
      <input type="hidden" name="pro_price" value="${bottomdetail.dto.pro_price}">
      <div class="container">
        <div class="row">
          <div class="col-lg-7">
            <!-- Carousel -->
            <div id="carouselCus1" class="js-carousel g-pt-10 g-mb-10"
					...
					<div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
						<img class="img-fluid2 w-100"
							src="${contextPath}/resources/product/${bottomdetail.dto.product_no}_1.jpg"
          ...
          <div class="col-lg-5">
            <div class="g-px-40--lg g-py-70">
              <!-- Product Info -->
              <div class="g-mb-30">
                <h1 class="g-font-weight-300 mb-4">${bottomdetail.dto.pro_name}</h1>
              ...
              <div class="d-flex justify-content-between align-items-center g-brd-bottom g-brd-gray-light-v3 py-3" role="tab">
                ...
                <ul class="list-inline mb-0">
                  <li class="list-inline-item g-mx-15">
                    <label class="form-check-inline u-check">
                      <input class="hidden-xs-up g-pos-abs g-top-0 g-left-0" name="pro_size" type="radio" value="S">
                      <div class="u-check-icon-checkbox-v4 g-brd-none g-absolute-centered--y g-left-0">
                        S
                      </div>
                    </label>
                  ...
                  <li class="list-inline-item g-mx-15">
                    <label class="form-check-inline u-check">
                      <input class="hidden-xs-up g-pos-abs g-top-0 g-left-0" name="pro_size" type="radio" value="M">
                      <div class="u-check-icon-checkbox-v4 g-brd-none g-absolute-centered--y g-left-0">
                        M
                      </div>
                    </label>
                  ...
                  <li class="list-inline-item g-mx-15">
                    <label class="form-check-inline u-check">
                      <input class="hidden-xs-up g-pos-abs g-top-0 g-left-0" name="pro_size" type="radio" value="L">
                      <div class="u-check-icon-checkbox-v4 g-brd-none g-absolute-centered--y g-left-0">
                        L
                      </div>
                    </label>
              ...
              <div class="d-flex justify-content-between align-items-center g-brd-bottom g-brd-gray-light-v3 py-3 g-mb-30" role="tab">
                ...
                <div class="js-quantity input-group u-quantity-v1 g-width-80 g-brd-primary--focus">
                  <input class="js-result form-control text-center g-font-size-13 rounded-0" type="text" name="quantity" value="1" readonly>
              ...
              <div class="row g-mx-minus-5 g-mb-20">
                ...
                <div class="col g-px-5 g-mb-10">
                  <button class="btn btn-block u-btn-outline-black g-brd-gray-dark-v5 g-brd-black--hover g-color-gray-dark-v4 g-color-white--hover g-font-size-12 text-uppercase g-py-15 g-px-25" type="button" onclick="goto_url('direct_shipping')">>
                    Go Order <i class="align-middle ml-2 icon-medical-022 u-line-icon-pro"></i>
                  </button>
                </div>
              </div>
              <!-- End Buttons -->
      ...
      <div id="details" class="container-fluid g-px-0">
        <div class="row no-gutters g-min-height-100vh">
          ...
          <div class="col-md-6 g-bg-size-cover g-min-height-300" data-bg-img-src="${contextPath}/resources/product/${bottomdetail.dto.product_no}_2.jpg"></div>
        </div>
      </div>
      <!-- End Details -->
