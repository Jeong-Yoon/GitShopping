...
<script>
	 function goto_url(act) {
	  document.top_detail.action = act;
	  document.top_detail.submit();
	}
</script>
...
<body>
	...
	<!-- Product Description -->
	<form name="top_detail" method="post" accept-charset="utf-8" onsubmit="document.charset='utf-8';">
      <input type="hidden" name="product_no" id="product_no" value="${topdetail.dto.product_no}"> 
      <input type="hidden" name="pro_name" value="${topdetail.dto.pro_name}">
      <input type="hidden" name="pro_price" value="${topdetail.dto.pro_price}">
	<div class="container">
		<div class="row" items="${toplist}">
			<div class="col-lg-7">
				<!-- Carousel -->
				<div id="carouselCus1" class="js-carousel g-pt-10 g-mb-10"
					...
					<div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
						<img class="img-fluid w-100"
							src="${contextPath}/resources/product/${topdetail.dto.product_no}_1.jpg"
							alt="Image Description">
					</div>
					<div class="js-slide g-cursor-pointer g-px-5">
						<img class="img-fluid"
							src="${contextPath}/resources/product/${topdetail.dto.product_no}_3.jpg"
							alt="Image Description">
					</div>
				</div>
			</div>
			...
			<div class="col-lg-5">
				<div class="g-px-40--lg g-py-70">
					<!-- Product Info -->
					<div class="g-mb-30">
						<h1 class="g-font-weight-300 mb-4">${topdetail.dto.pro_name}</h1>
					...
					<div class="g-mb-30">
						...
						<span class="g-color-black g-font-weight-500 g-font-size-30 mr-2">${topdetail.dto.pro_price}</span>
					</div>
					<!-- End Price -->
					...
					<div
						...
						<ul class="list-inline mb-0">
							<c:choose>
              <c:when test="${not empty topdetail.color}">
              <div class="selectbox"> 
              <select name="select_color"> 
              <option selected>-----</option>
                <c:forEach var="color" items="${topdetail.color}">
              <option>${color}</option> 
                </c:forEach>
              </select> 
              </div>
               ...
               <li class="list-inline-item g-mx-15">
					...
					<ul
						...
						<li class="nav-item g-brd-bottom g-brd-gray-dark-v4"><a
							...
							data-toggle="tab" href="#nav-1-1-default-hor-left--3" role="tab">Returns</a></li>
						<li class="nav-item g-brd-bottom g-brd-gray-dark-v4"><a
						...
						<li class="nav-item g-brd-bottom g-brd-gray-dark-v4"><a
							class="nav-link g-color-primary--active g-pa-0 g-pb-1"
							data-toggle="tab" href="#nav-1-1-default-hor-left--2" role="tab">Delivery</a></li>
					</ul>
					<!-- End Nav Tabs -->
	...
	<div id="details" class="container-fluid g-px-0">
		<div class="row no-gutters g-min-height-100vh">
			...
			<div class="col-md-6 g-bg-size-cover g-min-height-300"
				data-bg-img-src="${contextPath}/resources/WB0412697/html/assets/img-temp/900x900/img1.jpg"></div>
		</div>
	</div>
	<!-- End Details -->
		...
		<div class="row no-gutters g-min-height-100vh">
			<div class="col-md-6 flex-md-unordered align-self-center">
				<div class="g-width-60x mx-auto g-px-50--lg g-py-100">
					...
					<p>We believe in redefining classic silhouettes into modern
						pieces that function for busy people with busy lives. We want to
						create clothing that people will love and treasure for years to
						come – to become that trusty go-to you can't live without.</p>
				</div>
			</div>

			<div class="col-md-6 flex-md-first g-bg-size-cover g-min-height-300"
				data-bg-img-src="${contextPath}/resources/WB0412697/html/assets/img-temp/900x900/img2.jpg"></div>
		</div>
	</div>
	<!-- End Craftmanship -->
		...
		<div class="row no-gutters g-min-height-100vh">
			<div class="col-md-6 align-self-center">
				<div class="g-width-60x mx-auto g-px-50--lg g-py-100">
					...
					<p>Crafted from a water resistant fluid memory fabric to create
						an elegant draped effect when thrown on, this lightweight shell
						will take you from season to season and protect you from that
						unexpected shower.</p>
				</div>
			</div>

			<div class="col-md-6 g-bg-size-cover g-min-height-300"
				data-bg-img-src="${contextPath}/resources/WB0412697/html/assets/img-temp/900x900/img3.jpg"></div>
		</div>
	</div>
	<!-- End Caring -->
