	...
	<div class="container">
		<div class="row">
			<div class="col-lg-7">
				...
				<div id="carouselCus2"
					class="js-carousel text-center u-carousel-v3 g-mx-minus-5 g-mb-10"
					data-infinite="true" data-center-mode="true" data-slides-show="3"
					data-is-thumbs="true" data-nav-for="#carouselCus1">
					...
					<div class="js-slide g-cursor-pointer g-px-5">
						<img class="img-fluid"
							src="resources/WB0412697/html/assets/img-temp/250x170/img2.jpg"
							alt="Image Description">
					</div>
...
<!-- 								</div> -->
							...
							<ul
								...
								<li class="nav-item g-brd-bottom g-brd-gray-dark-v4"><a
									...
									data-toggle="tab" href="#nav-1-1-default-hor-left--3"
									role="tab">Returns</a></li>
								<li class="nav-item g-brd-bottom g-brd-gray-dark-v4"><a
									class="nav-link g-color-primary--active g-pa-0 g-pb-1"
									data-toggle="tab" href="#nav-1-1-default-hor-left--1"
									role="tab">View Size Guide</a></li>
								<li class="nav-item g-brd-bottom g-brd-gray-dark-v4"><a
									class="nav-link g-color-primary--active g-pa-0 g-pb-1"
									data-toggle="tab" href="#nav-1-1-default-hor-left--2"
									role="tab">Delivery</a></li>
							</ul>
							<!-- End Nav Tabs -->
							...
							<div id="nav-1-1-default-hor-left" class="tab-content">
								...
								<div class="tab-pane fade g-pt-30"
									...
									<h4 class="g-font-size-15 mb-3">General Clothing Size
										Guide</h4>
									...
									<table>
										<tbody>
											<tr class="g-color-gray-dark-v4 g-font-size-12">
												<td class="align-top g-width-150 g-py-5">Unify Size
													(UK)</td>
									...
									<table>
										...
										<tbody>
											<tr class="g-color-gray-dark-v4 g-font-size-12">
												...
												<td class="align-top g-font-size-11 g-py-10">2-3
													Working days</td>
											...
											<tr class="g-color-gray-dark-v4 g-font-size-12">
												...
												<td class="align-top g-font-size-11 g-py-10">Order
													before 12pm monday - thursday and receive it the next day</td>
											...
											<tr class="g-color-gray-dark-v4 g-font-size-12">
												...
												<td class="align-top g-py-10">Standard delivery</td>
												<td class="align-top g-font-size-11 g-py-10">3-9
													Working days</td>
		...
		<div id="details" class="container-fluid g-px-0">
			<div class="row no-gutters g-min-height-100vh">
				...
				<div class="col-md-6 g-bg-size-cover g-min-height-300"
					data-bg-img-src="resources/WB0412697/html/assets/img-temp/900x900/img1.jpg"></div>
			</div>
		</div>
		<!-- End Details -->
		...
		<div class="container-fluid g-px-0">
			<div class="row no-gutters g-min-height-100vh">
				...
				<div class="col-md-6 flex-md-first g-bg-size-cover g-min-height-300"
					data-bg-img-src="resources/WB0412697/html/assets/img-temp/900x900/img2.jpg"></div>
			</div>
		</div>
		<!-- End Craftmanship -->
			...
			<div class="row no-gutters g-min-height-100vh">
				<div class="col-md-6 align-self-center">
					<div class="g-width-60x mx-auto g-px-50--lg g-py-100">
						...
						<p>Crafted from a water resistant fluid memory fabric to
				...
				<div class="col-md-6 g-bg-size-cover g-min-height-300"
					data-bg-img-src="resources/WB0412697/html/assets/img-temp/900x900/img3.jpg"></div>
			</div>
		</div>
		<!-- End Caring -->
		...
		<script
			src="resources/WB0412697/html/assets/js/components/hs.count-qty.js"></script>
		<script
