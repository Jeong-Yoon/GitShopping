            ...
            <div id="carouselCus1" class="js-carousel g-pt-10 g-mb-10"
					...
					<div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
						<img class="img-fluid2 w-100"
							src="${contextPath}/resources/product/${shoesdetail.dto.product_no}_1.jpg"
...
<!--               End Buttons -->
      ...
      <div id="details" class="container-fluid g-px-0">
        <div class="row no-gutters g-min-height-100vh">
          ...
          <div class="col-md-6 g-bg-size-cover g-min-height-300" data-bg-img-src="${contextPath}/resources/product/${shoesdetail.dto.product_no}_2.jpg"></div>
        </div>
      </div>
      <!-- End Details -->
